...
void Pipeline::createGraphicsPipeline(std::string vertFile, std::string fragFile) {
	...
	auto fragShaderCode = shaderHelper.readFile(fragFile);

	VkShaderModule vertShaderModule = shaderHelper.createShaderModule(vertShaderCode);
	VkShaderModule fragShaderModule = shaderHelper.createShaderModule(fragShaderCode);
	...
	auto bindingDescription = GameObjectInfo.getInstance().getBindingDescription();
	auto attributeDescriptions = GameObjectInfo.getInstance().getAttributeDescriptions();
...
void Pipeline::createGraphicsPipelineOverlay(std::string vertFile, std::string fragFile) {
...
void Pipeline::createGeometryPassGraphicsPipeline(std::string vertFile, std::string fragFile) {
